...
const activeClassName =
  "block h-[50px] md:h-auto py-2 px-3 flex lg:border-none items-center lg:block lg:block text-white font-bold rounded md:bg-transparent dark:text-blue-400 md:p-0 dark:text-white md:dark:text-blue-500";
